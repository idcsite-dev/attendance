     ...
     <div class="row" style="margin-bottom:20px;">
          <div id="printableArea">
               <div class="container">
                    <div class="row" style="margin-top:50px;">
                         ...
                         <div class="col-lg-12" style="text-align:center;width:68%;">
                              <p style="font-size:35px;font-weight:bold;text-align:right;">DOKUMEN PRIBADI DAN RAHASIA
                              </p>
                         </div>
                    </div>
        ...
        if ($dt_payroll->tipe == "Non Staff") {
            ...
            ?>
                    ...
                    <!-- tabel ke 2 -->
                    <table id="tbdetail" class="text-small" style="margin-top:28px;">
                         <tr>
                              <td style="width:40%;">Tanggal</td>
                              <?php
        ...
        if (!empty($dt_p_detail_terima)) {
            foreach ($dt_p_detail_terima as $lstterima) {
                if (($lstterima->id_tambahan == 6 || $lstterima->id_tambahan == 4) && $lstterima->nilai > 0) {
                    echo '<tr>';
