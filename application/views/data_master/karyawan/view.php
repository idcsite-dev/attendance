...
<body>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <button type="button" class="btn btn-primary tooltips" id="syncData" data-bs-placement="top"
                                            title="Sinkronisasi Data"><i class="bi bi-arrow-repeat"></i></button>
    ...
    <?php $this->load->view('components/modal/karyawan')?>

    <?php $this->load->view('components/js')?>

    <script src="<?=base_url()?>assets/js/data_master/karyawan.js"></script>
