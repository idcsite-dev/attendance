...
<body>
                                   ...
                                   <div class="col-12">
                                        <div class="card">
                                             <div class="card-header">
                                                  <h2 class="card-title">Data Pesangon</h2>
                                                  ...
                                                  <button type="button" class="btn btn-danger tooltips"
                                                       id="hapusPesangon" data-bs-placement="top"
                                                       title="Hapus Data Pesangon"><i class="bi bi-trash"></i></button>
                                             </div>
     ...
     <?php $this->load->view('components/modal/pesangon')?>

     <?php $this->load->view('components/js')?>

     <script src="<?=base_url()?>assets/js/data_master/pesangon.js"></script>
