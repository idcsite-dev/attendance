...
<body>
                                   ...
                                   <div class="col-12">
                                        <div class="card">
                                             <div class="card-header">
                                                  <h2 class="card-title">Data Rapelan</h2>
                                                  ...
                                                  <button type="button" class="btn btn-danger tooltips"
                                                       id="hapusRapelan" data-bs-placement="top"
                                                       title="Hapus Data Rapelan"><i class="bi bi-trash"></i></button>
                                             </div>
     ...
     <?php $this->load->view('components/modal/rapelan')?>

     <?php $this->load->view('components/js')?>

     <script src="<?=base_url()?>assets/js/data_master/rapelan.js"></script>
