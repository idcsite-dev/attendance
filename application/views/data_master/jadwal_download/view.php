...
<body>
                                   ...
                                   <div class="col-12">
                                        <div class="card">
                                             <div class="card-header">
                                                  <h2 class="card-title">Data Jadwal Download </h2>
                                             </div>
     ...
     <?php $this->load->view('components/modal/jadwal_download')?>

     <?php $this->load->view('components/js')?>

     <script src="<?=base_url()?>assets/js/data_master/jadwal_download.js"></script>
