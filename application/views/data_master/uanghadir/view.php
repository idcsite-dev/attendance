...
<body>
                                   ...
                                   <div class="col-12">
                                        <div class="card">
                                             <div class="card-header">
                                                  <h2 class="card-title">Data Uang hadir</h2>
                                                  ...
                                                  <button type="button" class="btn btn-danger tooltips"
                                                       id="hapusUanghadir" data-bs-placement="top"
                                                       title="Hapus Data Uanghadir"><i class="bi bi-trash"></i></button>
                                             </div>
     ...
     <?php $this->load->view('components/modal/uanghadir')?>

     <?php $this->load->view('components/js')?>

     <script src="<?=base_url()?>assets/js/data_master/uanghadir.js"></script>
