...
<body>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h2 class="card-title">Jenis Data</h2>
    ...
    <?php $this->load->view('components/modal/jenis_keterangan')?>

    <?php $this->load->view('components/js')?>

    <script src="<?=base_url()?>assets/js/data_master/jenis_keterangan.js"></script>
