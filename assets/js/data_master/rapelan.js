$(document).ready(function () {
  ...
  // Load DataTables
  $("#dataTable").load(site_url + "Rapelan/dataTables", function () {
    $("#table1").DataTable();
    initTooltips();
  });
  ...
  // Submit Event
  $("#addRapelan").submit(function () {
    $.LoadingOverlay("show");
    let rapelan = $("#rapelan").val();
  ...
  // Click Event
  $("#HapusRapelan").click(function () {
    let bulan = $("#lstBulanHapus").val();
    let tahun = $("#lstTahunHapus").val();

    window.location.href =
      site_url + "rapelan/deleteRpl?bln=" + bulan + "&thn=" + tahun;
  });

  // Click Event
  $("#exportRapelan").click(function () {
    let bulan = $("#lstBulan").val();
    let tahun = $("#lstTahun").val();

    window.location.href =
      site_url + "rapelan/sample?bln=" + bulan + "&thn=" + tahun;
  });
